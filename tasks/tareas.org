...
* TODO Pagar el piso
  SCHEDULED: <2016-05-05 jue ++1m>
  :PROPERTIES:
  :LAST_REPEAT: [2016-04-07 jue 13:09]
...
** TODO Preparar CAEPIA, MAEB
   DEADLINE: <2016-04-25 lun>
** TODO [#A] Preparar/Repasar clase de AS
   DEADLINE: <2016-04-13 mié> SCHEDULED: <2016-05-17 mar ++1w>
   :PROPERTIES:
   :ORDERED:  t
   :LAST_REPEAT: [2016-04-17 dom 15:05]
   :END:
...
** TODO Registrar el portátil de Amalia en el registro
...
** TODO Implementar en C++ usando el Armadillo los ejercicios del Máster. 

** TODO Ofrecer también en Python.
